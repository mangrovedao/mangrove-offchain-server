...
async function main() {
  ...
  const schema = await buildSchema({
    resolvers: [
      ...
      graphql.FindManyOfferListingResolver,
      graphql.FindManyOfferListingVersionResolver,
      ...
      graphql.AggregateOfferListingResolver,
      ...
      graphql.GroupByOfferListingResolver,
      ...
      graphql.FindUniqueOfferListingResolver,
      ...
      graphql.OfferListingRelationsResolver,
